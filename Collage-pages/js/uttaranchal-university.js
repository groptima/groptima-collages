/*============================================
  UTTARANCHAL UNIVERSITY - COMPLETE INDEPENDENT JS
  Groptima – College
...
// ====== CONSOLE EASTER EGG ======
console.log('%cUttaranchal University 🎓', 'color: #3b82f6; font-size: 24px; font-weight: bold;');
console.log('%cFirst A+ NAAC in Uttarakhand', 'color: #6b7280; font-size: 14px;');
